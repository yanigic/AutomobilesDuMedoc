...
const fetchData = async () => {
  try {
    ...
    projects.value = content.body
      .filter(
        (project) =>
          project.imgTwoColumsOne &&
          project.imgTwoColumsTwo &&
          project.imgTwoColumsThree
      )
      .map((project) => {
  ...
  <div v-if="projects.length > 0">
    <div v-for="(project, index) in projects" :key="index">
      <div id="carousel-imgTwoColumns" class="carousel-imgTwoColumns">
        <div class="square">
          <img :src="project.imgTwoColumsOne" alt="Image 1" />
        </div>
        <div class="square">
          <img :src="project.imgTwoColumsTwo" alt="Image 2" />
        </div>
        <div class="square">
          <img :src="project.imgTwoColumsThree" alt="Image 3" />
        </div>
      </div>
